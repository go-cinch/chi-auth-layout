...
{{ end }}
	if err != nil { server.WriteError(w, r, http.StatusBadRequest, apperror.UserGroupID); return }
...
{{ end }}
	...
	if errors.Is(err, ErrUserNotFound) { server.WriteError(w, r, http.StatusNotFound, ErrUserNotFound); return }
